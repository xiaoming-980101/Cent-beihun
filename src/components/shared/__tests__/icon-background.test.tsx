...
describe("IconBackground Component", () => {
    ...
    it("renders with purple variant (default)", () => {
        const { container } = render(<IconBackground icon={<div>Icon</div>} />);
    ...
    it("accepts custom className", () => {
        const { container } = render(
            <IconBackground icon={<div>Icon</div>} className="custom-class" />,
        );
    ...
    it("forwards ref correctly", () => {
        ...
        render(<IconBackground icon={<div>Icon</div>} ref={ref} />);
