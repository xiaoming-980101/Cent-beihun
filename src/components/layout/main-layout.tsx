...
import { BottomNavBar, type BottomNavBarProps, defaultBottomNavItems } from './bottom-nav-bar';
...
export interface MainLayoutProps {
  ...
  navBarProps?: Omit<BottomNavBarProps, 'items'> & { items?: BottomNavBarProps['items'] };
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className={cn(topPadding, bottomPadding)}>
        <div className={cn('px-4 py-6', contentClassName)}>{children}</div>
      </main>
