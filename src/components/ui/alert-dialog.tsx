...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Action
        ...
        className={cn(
            buttonVariants(),
            "h-10 rounded-full bg-[color:var(--wedding-text)] px-5 text-white hover:bg-[color:var(--wedding-text)]/90",
            className,
        )}
        {...props}
    />
...
>(({ className, ...props }, ref) => (
    <AlertDialogPrimitive.Cancel
        ...
        className={cn(
            ...
            "mt-2 h-10 rounded-full border-[color:var(--wedding-line)] text-[color:var(--wedding-text-mute)] hover:bg-[color:var(--wedding-surface-muted)] sm:mt-0",
            className,
        )}
        {...props}
    />
