      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-body text-text-secondary">
            Components customized according to Figma design specifications
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Customized with design system colors and proper theme support
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              12px border radius, 20px padding, custom shadow effect
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <Card className="hover:shadow-lg">
                ...
                <CardContent>
                  <p className="text-body text-text-primary">
                    Card content with proper padding and spacing
                  </p>
                </CardContent>
                <CardFooter>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-body text-text-primary mb-4">
              Toggle the theme using the theme switcher to see how components adapt.
              All colors are defined using CSS variables that change based on the theme.
            </p>
